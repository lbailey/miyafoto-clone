...
(function (b) {
    if (b.fn.ajaxForm == undefined) {
        b.getScript("includes/jquery.form.js")
    }
    var a = {};
    ...
    b.fn.uploadFile = function (t) {
        var r = b.extend({
            ...
            deletelStr: "x",
            doneStr: "&#10004;",
            counterSpan: b("<span class='upload-counter'></span>"),
            uploadingSpan: b("<span class='status-uploading'>Uploading </span>"),
        	totalSpan: b("<span class='status-total'></span>"),
        ...
        this.fileCounter = 1;
        this.totalFileCounter = 0;
        this.progressFileCounter = 0;
        ...
        var counter = r.counterSpan;
        //Sv.appendTo("#mulitplefileuploader");
        //Sv.appendTo("body");
        $("#status").html(r.uploadingSpan);
        $("#status").insertAfter("#mulitplefileuploader");
        $("#status").append(counter);
        $("#status").append("&nbsp;of&nbsp;");
        $("#status").append(r.totalSpan);
        $("#status").hide();
            ...
            if (r.afterUploadAll && !g) {
                ...
                (function s() {
                    if (m.sCounter != 0 && (m.sCounter + m.fCounter == m.tCounter)) {
                        r.afterUploadAll(m);
                        m.progressFileCounter = 0;
                        m.totalFileCounter = 0;
                        g = false
                    } else {
        ...
        function l(H, B, u) {
            ...
            H.totalSpan.html(B.totalFileCounter);
            B.totalFileCounter = 0;
        }
        function c(w, v, y) {
        ...
        function q(y, B, D, u) {
            ...
            if (D.multiple) {
                ...
                v = "<input class='hidden-input' type='file' id='" + A + "' name='" + D.fileName + "' multiple/>"
            }
            ...
            var v = {
                ...
                success: function (B, s, C) {
                    ...
                    if (y.showStatusAfterSuccess) {
                        ...
                        if (y.showStatusCounter) {
                        	A.progressFileCounter++;
                        	y.counterSpan.html(A.progressFileCounter);
                        } else {
                        	y.counterSpan.hide();
                        }	
                    } else {
